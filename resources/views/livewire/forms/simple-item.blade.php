...
>
    ...
    <div class="text-end hidden">
        ...
        <button wire:click="kirim_laporan" type="button" class="text-white bg-blue-500 rounded-md shadow px-3 py-2">Simpan</button>
